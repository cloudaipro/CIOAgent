...
_BASE_RULES = (
    ...
    "the specified fields plus vote (BUY|HOLD|SELL), confidence (0-100), and reason."
)
...
SPECIALISTS: list[dict] = [
    {
        ...
        "fields": ["market_trend", "market_score", "macro_risks", "capital_flows"],
    },
    {
        "key": "equity",
    ...
    },
    {
        ...
        "fields": ["industry_score", "industry_cycle", "tailwinds", "headwinds"],
    },
    {
        "key": "valuation",
        "title": "Valuation",
    ...
    },
    {
        ...
        "fields": ["trend_score", "momentum_signal", "probability_upside"],
    },
    {
        "key": "etf",
        "title": "ETF Research",
    ...
    },
    {
        ...
        "fields": ["risk_score", "major_risks", "worst_case_scenario"],
    },
    {
        "key": "catalyst",
        "title": "Catalyst",
        ...
        "fields": ["bullish_catalysts", "bearish_catalysts", "event_timeline"],
    },
]
