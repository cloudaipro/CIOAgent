...
def test_cio_tools_count():
    """CIO_TOOLS must be exactly 45: the portfolio/research tools plus
    run_committee, evidence-integrity, strategy-profile, watchlist operations,
    request_swing_scan, and the 2 surviving
    ...
    assert len(CIO_TOOLS) == 45, f"CIO_TOOLS count changed: {len(CIO_TOOLS)}"
